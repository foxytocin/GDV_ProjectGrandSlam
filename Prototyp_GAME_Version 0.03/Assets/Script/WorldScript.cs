...
public class WorldScript : MonoBehaviour
{
    ...
    void createWalls(int rowPosition)
    {
        ...
        if (rowPosition % 2 == 0)
        {
            ...
            {
                GameObject wand;
                wand = Instantiate(levelWand, new Vector3(i, 0, rowPosition), Quaternion.Euler(0, elementRotation, 0));
                wand.name = "Wand";
                //wand.transform.position = new Vector2(i, rowPosition);
                wand.transform.parent = transform;

                //Generiert eine Saeule
                if ((((int)Mathf.Round(Random.value * 10)) == 0))
                {
                    GameObject wand_saule;
                    wand_saule = Instantiate(levelWand, new Vector3(i, 1f, rowPosition), Quaternion.Euler(0, elementRotation, 0));
                ...
                if ((((int)Mathf.Round(Random.value * 10)) == 0) && ((i > 1) && ((i < levelBreite - 2))))
                {
            ...
            {
                if ((((int)Mathf.Round(Random.value * 10)) % 5 == 0))
                {
                    GameObject kiste;
                    kiste = Instantiate(levelKiste, new Vector3(i, 0, rowPosition), Quaternion.Euler(0, elementRotation, 0));
            ...
            {
                if ((((int)Mathf.Round(Random.value * 10)) % 4 == 0))
                {
                    GameObject kiste;
                    kiste = Instantiate(levelKiste, new Vector3(i, 0, rowPosition), Quaternion.Euler(0, elementRotation, 0));
                    kiste.transform.parent = transform;
